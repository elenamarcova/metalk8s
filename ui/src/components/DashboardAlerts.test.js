...
describe('the dashboard alerts sub-panel', () => {
  ...
  test('alerts should be displayed', () => {
    const { getByTestId } = render(
      <DashboardAlerts leafAlerts={[...alertsCritical, ...alertsWarning]} />,
    );
  ...
  test('no alert should be displayed', () => {
    const { queryByTestId, getByTestId, getByText } = render(
      <DashboardAlerts leafAlerts={[]} />,
    );
  ...
  test('view all link should redirect to /alerts page', () => {
    const { getByTestId } = render(
      <DashboardAlerts leafAlerts={[...alertsCritical, ...alertsWarning]} />,
    );
